<?php
/**
 * TinydbBlockTabSettingComponent
 */
	...
	public function beforeRender(Controller $controller) {
		$controller->helpers['Blocks.BlockTabs'] = array(
			'mainTabs' => array(
				'block_index' => array(
					'url' => array(
						'controller' => \NetCommons\Tinydb\Lib\CurrentDbType::instance(
							)->getDbTypeKey() . '_blocks'
					)
				),
				'frame_settings' => array(
					'url' => array(
						'controller' => \NetCommons\Tinydb\Lib\CurrentDbType::instance(
							)->getDbTypeKey() . '_frame_settings'
					)
				),
			),
			'blockTabs' => array(
				...
				'role_permissions' => array(
					'url' => array(
						'controller' => \NetCommons\Tinydb\Lib\CurrentDbType::instance(
							)->getDbTypeKey() . '_block_role_permissions'
					)
				),
			),
		);
