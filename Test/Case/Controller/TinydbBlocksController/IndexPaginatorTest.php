<?php
/**
 * TinydbBlocksController::index()のPaginatorテスト
 *
 ...
 */
class TinydbBlocksControllerIndexPaginatorTest extends BlocksControllerPaginatorTest {
 ...
 */
	public $fixtures = array(
		...
		'plugin.tinydb.tinydb4paginator',
